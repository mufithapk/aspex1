<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="page5.aspx.cs" Inherits="aspex1.page5" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="TextBox2" ErrorMessage="age between 20 and 60" MaximumValue="60" MinimumValue="20" Type="Integer"></asp:RangeValidator>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
